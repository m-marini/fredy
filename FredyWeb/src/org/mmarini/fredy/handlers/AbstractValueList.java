...
public abstract class AbstractValueList implements IValueList, Serializable {
	...
	/**
	 * @see org.mmarini.fredy.handlers.IValueList#getElements()
	 */
	@Override
	...
	/**
	 * @see org.mmarini.fredy.handlers.IValueList#getIndex()
	 */
	@Override
	public int getIndex() {
		return index;
	...
	/**
	 * @see org.mmarini.fredy.handlers.IValueList#getPageCount()
	 */
	@Override
	...
	/**
	 * @see org.mmarini.fredy.handlers.IValueList#getPageNumber()
	 */
	@Override
	...
	/**
	 * @see org.mmarini.fredy.handlers.IValueList#getSize()
	 */
	@Override
	public int getSize() {
	...
	/**
	 * @see org.mmarini.fredy.handlers.IValueList#getSubListSize()
	 */
	@Override
	...
	/**
	 * @see org.mmarini.fredy.handlers.IValueList#setIndex(int)
	 */
	@Override
	...
	/**
	 * @see org.mmarini.fredy.handlers.IValueList#setSubListSize(int)
	 */
	@Override
	...
	/**
	 * @see org.mmarini.fredy.handlers.IValueList#skip(int)
	 */
	@Override
