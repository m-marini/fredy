...
/**
 * @author US00852
 * @version $Id: EvidenceComparatorTest.java,v 1.2 2005/02/10 22:32:35 marco Exp
 *          $
 */
public class EvidenceComparatorTest extends TestCase {
	FuzzyBoolean values[][];
	int expected[];
	...
	public void testCompare() {
		for (int i = 0; i < values.length; ++i) {
			...
			int diff = EvidenceComparator.getInstance().compare(predicate1,
					predicate2);
